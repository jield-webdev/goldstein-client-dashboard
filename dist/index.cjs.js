...
var GoldsteinDataContext = React.createContext(undefined);
function GoldsteinDataProvider(_a) {
    var children = _a.children, defaultData = _a.defaultData;
    var _b = React.useState(defaultData), goldsteinData = _b[0], setGoldsteinData = _b[1];
    return (React.createElement(GoldsteinDataContext.Provider, { value: { goldsteinData: goldsteinData, setGoldsteinData: setGoldsteinData } }, children));
}
var useGoldsteinClientDataContext = function () {
    var context = React.useContext(GoldsteinDataContext);
...
function ServerError() {
    return (React.createElement("div", { className: "text-center" },
        React.createElement("div", { className: "alert alert-danger mb-4", role: "alert" },
            React.createElement("h1", { className: "h4 alert-heading" }, "Server Error"),
            React.createElement("hr", null),
            React.createElement("p", { className: "mb-0" }, "Unable to connect to the server. Please check your connection and try again.")),
        React.createElement("div", { className: "d-grid gap-2 col-6 mx-auto" },
            React.createElement("button", { className: "btn btn-outline-secondary", type: "button", onClick: function () { return window.location.reload(); } }, "Refresh Page"))));
}

function WaitingCardDetection() {
    return (React.createElement("div", { className: "text-center" },
        React.createElement("h1", { className: "display-4 mb-3" }, "Waiting for card detection"),
...
function NoUserInCard(_a) {
    ...
    var _b = React.useState(undefined), onboardingWord = _b[0], setOnboardingWord = _b[1];
    ...
    return (React.createElement("div", { className: "text-center" },
        React.createElement("div", { className: "alert alert-warning mb-4", role: "alert" },
            React.createElement("h1", { className: "h4 alert-heading" }, "No user is registered in the card")),
        React.createElement("div", { className: "card mb-3" },
            React.createElement("div", { className: "card-header bg-light-subtle" }, "Card Information"),
            React.createElement("div", { className: "card-body" },
                React.createElement("p", { className: "card-text" },
                    React.createElement("strong", null, "Badge UUID:"),
                    " ",
                    React.createElement("code", null, badgeUID)),
                onboardingWord && (React.createElement("p", { className: "card-text" },
                    React.createElement("strong", null, "Your secret word:"),
                    " ",
                    React.createElement("code", null, onboardingWord))))),
        React.createElement("button", { type: "button", className: "btn btn-primary", onClick: registerBadgeHelper }, "Register badge")));
}
...
function UserNotAuthorized(_a) {
    ...
    return (React.createElement("div", { className: "text-center" },
        React.createElement("div", { className: "alert alert-danger mb-4", role: "alert" },
            React.createElement("h1", { className: "h4 alert-heading" }, "This user cannot use the equipment"),
            React.createElement("hr", null),
            React.createElement("p", { className: "mb-0" }, "Access denied due to insufficient permissions")),
        React.createElement("div", { className: "card mb-3" },
            React.createElement("div", { className: "card-header bg-light-sublte" }, "User Information"),
            React.createElement("ul", { className: "list-group list-group-flush" },
                React.createElement("li", { className: "list-group-item d-flex justify-content-between align-items-center" },
                    ...
                    React.createElement("span", { className: "badge bg-secondary" }, userName)),
                React.createElement("li", { className: "list-group-item d-flex justify-content-between align-items-center" },
                    React.createElement("span", null, "Badge UUID:"),
                    React.createElement("code", null, badgeUUID))))));
}
...
function UpdateStatus(_a) {
    ...
    var _d = React.useState(null), selectedModuleId = _d[0], setSelectedModuleId = _d[1];
    var _e = React.useState(null), statusId = _e[0], setStatusId = _e[1];
    var _f = React.useState(""), description = _f[0], setDescription = _f[1];
    var _g = React.useState([]), statusOptions = _g[0], setStatusOptions = _g[1];
    var _h = React.useState(false), submitting = _h[0], setSubmitting = _h[1];
    var goldsteinData = useGoldsteinClientDataContext().goldsteinData;
    var queries = reactQuery.useQueries({
        queries: [
            {
    ...
    return (React.createElement("div", { className: "card mb-4" },
        React.createElement("div", { className: "card-header bg-light-subtle" }, "Update Status"),
        React.createElement("form", { onSubmit: handleSubmit, className: "needs-validation p-3", noValidate: true },
            React.createElement("div", { className: "mb-3" },
                React.createElement("label", { htmlFor: "moduleSelect", className: "form-label" }, "Module"),
                isLoading ? (React.createElement("div", null, "Loading modules...")) : ((_b = equipmentModulesQuery.data) === null || _b === void 0 ? void 0 : _b.length) === 0 ? (React.createElement("div", null, "No modules available")) : (React.createElement("select", { className: "form-select", id: "moduleSelect", value: selectedModuleId || "", onChange: function (e) { return setSelectedModuleId(Number(e.target.value)); }, required: true, disabled: submitting }, (_c = equipmentModulesQuery.data) === null || _c === void 0 ? void 0 : _c.map(function (module) { return (React.createElement("option", { key: module.id, value: module.id },
                    module.name,
                    " (",
                    module.type.type,
                    ")")); })))),
            React.createElement("div", { className: "mb-3" },
                ...
                isLoading ? (React.createElement("div", null, "Loading status options...")) : (React.createElement("select", { className: "form-select", id: "statusSelect", value: statusId !== null && statusId !== void 0 ? statusId : "", onChange: function (e) { return setStatusId(Number(e.target.value)); }, required: true, disabled: submitting || !selectedModuleId }, statusOptions.map(function (option) { return (React.createElement("option", { key: option.id, value: option.id, style: {
                        color: option.front_color,
                        backgroundColor: option.back_color,
                    } }, option.status)); })))),
            React.createElement("div", { className: "mb-3" },
                React.createElement("label", { htmlFor: "description", className: "form-label" }, "Description (optional)"),
                React.createElement("textarea", { id: "description", className: "form-control", value: description, onChange: function (e) { return setDescription(e.target.value); }, rows: 3, placeholder: "Add a description about the status update", disabled: submitting || !selectedModuleId })),
            React.createElement("button", { type: "submit", className: "btn btn-primary", disabled: submitting || isLoading || !selectedModuleId }, submitting ? "Updating..." : "Update Status"))));
}
...
function EquipmentUsable(_a) {
    ...
    return (React.createElement("div", { className: "text-center" },
        React.createElement("div", { className: "alert alert-success mb-4", role: "alert" },
            React.createElement("h1", { className: "h4 alert-heading" }, "You can use the equipment"),
            React.createElement("hr", null),
            React.createElement("p", { className: "mb-0", id: "session-left-time" },
        ...
        React.createElement("div", { className: "card mb-4" },
            ...
            React.createElement("ul", { className: "list-group list-group-flush" },
                React.createElement("li", { className: "list-group-item d-flex justify-content-between align-items-center" },
                    React.createElement("span", null, "User:"),
                    React.createElement("span", { className: "badge bg-primary" }, userName)),
                React.createElement("li", { className: "list-group-item d-flex justify-content-between align-items-center" },
                    React.createElement("span", null, "Badge UUID:"),
                    React.createElement("code", null, badgeUUID)),
                React.createElement("li", { className: "list-group-item d-flex justify-content-between align-items-center" },
...
function NullNotifications() {
    return (React.createElement("div", { className: "text-center mt-5" },
        React.createElement("div", { className: "alert alert-secondary border rounded-3 shadow-sm p-4 mx-auto", style: { maxWidth: "600px" }, role: "alert" },
            React.createElement("h2", { className: "h5 text-muted mb-3" }, "No Notifications Found"),
            React.createElement("p", { className: "text-secondary mb-0" }, "There are currently no Goldstein clients available for this association, or the service might be temporarily down.")),
        React.createElement("div", { className: "d-grid gap-2 col-6 mx-auto mt-3" },
            React.createElement("button", { className: "btn btn-outline-primary btn-sm", type: "button", onClick: function () { return window.location.reload(); } }, "Refresh Page"))));
}
...
function GoldsteinClientDashboard() {
    var goldsteinData = useGoldsteinClientDataContext().goldsteinData;
    var wsRef = React__namespace.useRef(null);
    ...
    var _b = React__namespace.useState(0), timeLeft = _b[0], setTimeLeft = _b[1];
    ...
    return (React__namespace.createElement("div", { className: "container mt-4" },
        React__namespace.createElement("div", { className: "row justify-content-center" },
            React__namespace.createElement("div", { className: "col-md-10 col-lg-8" },
                React__namespace.createElement("div", { className: "card shadow" },
                    React__namespace.createElement("div", { className: "card-body" },
                        renderingState.status === RenderingEnum.SERVER_ERROR && (React__namespace.createElement(ServerError, null)),
                        renderingState.status === RenderingEnum.NULL_NOTIFICATIONS && (React__namespace.createElement(NullNotifications, null)),
                        renderingState.status ===
                            RenderingEnum.WAITING_CARD_DETECTION && (React__namespace.createElement(WaitingCardDetection, null)),
                        renderingState.status === RenderingEnum.CARD_READ && (React__namespace.createElement(NoUserInCard, { badgeUID: renderingState.badgeUUID })),
                        renderingState.status === RenderingEnum.USER_NOT_AUTHORIZED && (React__namespace.createElement(UserNotAuthorized, { badgeUUID: renderingState.badgeUUID, userName: renderingState.userName })),
                        renderingState.status === RenderingEnum.EQUIPMENT_USABLE && (React__namespace.createElement(EquipmentUsable, { badgeUUID: renderingState.badgeUUID, userName: renderingState.userName, userID: renderingState.userID, clientAssociation: "".concat(renderingState.association), timeLeft: timeLeft }))))))));
}

exports.GoldsteinClientDashboard = GoldsteinClientDashboard;
exports.GoldsteinDataContext = GoldsteinDataContext;
exports.GoldsteinDataProvider = GoldsteinDataProvider;
exports.useGoldsteinClientDataContext = useGoldsteinClientDataContext;
